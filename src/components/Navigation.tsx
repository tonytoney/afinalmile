      ...
      <nav className="container-custom mx-auto px-4 sm:px-6 lg:px-8" aria-label="Global">
          ...
          <div className="flex lg:flex-1">
            <Link href="/" className="-m-1.5 p-1.5">
              <Image
                ...
                priority
              />
              <span className="sr-only">Albany Final Mile</span>
            </Link>
          </div>
        ...
        {mobileMenuOpen && (
          <div className="fixed inset-0 z-50 lg:hidden">
            ...
            {/* Menu panel */}
            <div className="fixed inset-y-0 right-0 z-50 w-full md:w-80 h-full flex flex-col bg-white dark:bg-gray-900 px-6 py-6 shadow-xl dark:shadow-2xl">
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  <span className="text-xl font-bold text-primary">ALBANY</span>
                  <span className="text-sm ml-1 text-gray-600 dark:text-gray-400">FINAL MILE</span>
                </div>
                <button
                  type="button"
                    ...
                    {navigation.map((item) => (
                      item.external ? (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-gray-900 dark:text-white bg-gray-50 dark:bg-gray-800 mb-2 hover:bg-gray-100 dark:hover:bg-gray-700 transition-colors"
                        >
                          {item.name}
                        </a>
                      ) : (

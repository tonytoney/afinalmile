  ...
  return (
    <main className="pt-24 pb-16 animate-fade-in bg-white dark:bg-gray-900">
      <div className="container-custom">
        ...
        >
          <h1 className="text-4xl font-bold mb-4 text-gray-900 dark:text-white">Drive With Albany Final Mile</h1>
          <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Join our team of professional drivers and be part of a company that values safety, reliability, and growth in final mile logistics.
          </p>
        </motion.div>

...
export const metadata: Metadata = {
  title: 'Driver Application | Albany Final Mile',
  description: 'Apply to become a professional driver with Albany Final Mile. Join our team of dedicated final mile delivery professionals.',
}

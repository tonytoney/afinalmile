          ...
          <div className="prose dark:prose-invert max-w-none">
            ...
            <section className="mb-12">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Albany Final Mile ("we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website.
              </p>
            </section>
